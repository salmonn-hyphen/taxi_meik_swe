...
import {
  User as UserIcon, Mail, Phone, Lock, Shield, Eye, EyeOff, Save, Calendar, AlertCircle
} from 'lucide-react'
...
export function AdminProfilePage() {
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8 px-4 py-6 animate-fade-in">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-extrabold tracking-tight text-slate-900 dark:text-white">Profile Settings</h1>
          <p className="text-slate-500 dark:text-slate-400 mt-1">Manage your administrator account details, phone, and security credentials.</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
        ...
        >
          <Card className="overflow-hidden border border-slate-100 dark:border-slate-800 shadow-md">
            <div className="h-24 bg-gradient-to-r from-rose-500 to-indigo-600" />
            <CardContent className="relative pt-0 pb-6 text-center">
              ...
              <div className="mt-4 flex flex-wrap justify-center gap-2">
                <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold bg-rose-100 text-rose-800 dark:bg-rose-950/50 dark:text-rose-400">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            <Card className="border border-slate-100 dark:border-slate-800 shadow-md">
              <CardHeader>
                ...
                <CardDescription>Update your administrator name and phone number.</CardDescription>
              </CardHeader>
            ...
            <div className="flex justify-end">
              <Button type="submit" size="lg" className="px-6 gap-2 bg-rose-600 hover:bg-rose-700 text-white" disabled={loading}>
